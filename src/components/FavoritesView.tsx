...
export function FavoritesView() {
  return (
    <div className="flex-1 flex flex-col items-center justify-center bg-surface-lowest font-sans h-full overflow-hidden p-8">
      <div className="w-24 h-24 bg-surface-low rounded-[2.5rem] shadow-xl flex items-center justify-center mb-8 border border-outline-variant rotate-3 hover:rotate-6 transition-transform group">
